# Generated by Powerlevel10k configuration wizard on 2025-11-23 at 10:03 +01.
...
() {
  ...
  # Disable ALL Powerlevel10k syntax highlighting
  typeset -g POWERLEVEL10K_DISABLE_HIGHLIGHTING=true
  typeset -g POWERLEVEL9K_DISABLE_HIGHLIGHTING=true
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#00F769'

  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#E96379'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#D58C9B'
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#D58C9B'  
  # prefix. The shortened directory can be tab-completed to the original.
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique
  # Replace removed segment suffixes with this symbol.
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER=
  # Color of the shortened directory segments.
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#EAD7E9'
  ...
  # Git colors (Tokyo Night)
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#8af38a'      # success green
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#ff9ace'  # magenta
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#ff6d8a'   # rose
