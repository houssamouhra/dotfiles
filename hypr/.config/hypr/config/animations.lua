...
-- Windows
hl.animation { leaf = 'border', enabled = true, speed = 2, bezier = 'emphasizedDecel' }
...
-- Layers
hl.animation { leaf = 'layersIn', enabled = true, speed = 0.7, bezier = 'emphasizedDecel', style = 'popin 93%' }
hl.animation { leaf = 'layersOut', enabled = true, speed = 0.7, bezier = 'menu_accel', style = 'popin 94%' }
hl.animation { leaf = 'fadeLayersIn', enabled = true, speed = 0.5, bezier = 'menu_decel' }
hl.animation { leaf = 'fadeLayersOut', enabled = true, speed = 0.8, bezier = 'emphasizedAccel' }
